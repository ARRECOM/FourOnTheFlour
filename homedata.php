<div class="container">
  <div class="row">
      ...
      <div class="owl-carousel owl-theme slide" id="featured">
        <div class="item">
          <article class="featured">
            ...
            <figure>
              <img src="images/ff/space.jpg" alt="Sample Article">
            </figure>
            <!--<div class="details">
        ...
        <div class="item">
          <article class="featured">
            <div class="overlay"></div>
            <figure>
              <img src="images/ff/16.jpeg" alt="Sample Article">
            </figure>
            <div class="details">
              <div class="category"><a href="category.html">Texto</a></div>
              <h1><a href="single.html">Texto</a></h1>
              <div class="time">Texto</div>
            </div>
          </article>
        </div>
          ...
          <div class="row">
            <article class="article col-md-12">
              <div class="inner">
                ...
                <div class="padding">
                  <div class="detail">
                    <div class="time">Texto</div>
                    <div class="category"><a href="#">Texto</a></div>
                  </div>
            ...
            <article class="article col-md-12">
              <div class="inner">
                <figure>
                  <a href="single.html">
                    <img src="images/ff/17.jpeg" alt="Sample Article">
                  </a>
                </figure>
                  <div class="padding">
                  <div class="detail">
          ...
          <div class="row">
            <article class="article col-md-12">
              <div class="inner">
                <figure>
                  <a href="single.html">
                    <img src="images/ff/18.jpeg" alt="Sample Article">
                  </a>
                </figure>
                <div class="padding">
                  <div class="detail">
            ...
            <article class="article col-md-12">
              <div class="inner">
                <figure>
                  <a href="single.html">
                    <img src="images/ff/19.jpeg" alt="Sample Article">
                  </a>
                </figure>
                <div class="padding">
                  <div class="detail">
          ...
          <div class="body-col vertical-slider" data-max="4" data-nav="#hot-news-nav" data-item="article">
            ...
            <article class="article-mini">
              <div class="inner">
                <figure>
                  <a href="single.html">
                    <img src="images/ff/20.jpeg" alt="Sample Article">
                  </a>
                </figure>
                <div class="padding">
                  <h1><a href="single.html">Duis aute irure dolor in reprehenderit in voluptate velit</a></h1>
            ...
            <article class="article-mini">
              <div class="inner">
                <figure>
                  <a href="single.html">
                    <img src="images/ff/21.jpeg" alt="Sample Article">
                  </a>
                </figure>
                <div class="padding">
    ...
    <div class="col-xs-6 col-md-4 sidebar" id="sidebar">
        ...
        <div class="aside-body">
          <div class="featured-author">
            <div class="featured-author-inner">
              <div class="featured-author-cover" style="background-image: url('images/ff/16.jpeg');">
                <div class="badges">
              ...
              <!--<div class="featured-author-body">
                <!--<div class="featured-author-count">
                  <div class="item">
                    <a href="#">
                      <div class="name">Visitantes</div>
                      <div class="value">208</div>
                    </a>
                  </div
                  <div class="item">
                    <a href="#">
                      <div class="name">Artistas</div>
      ...
      <aside>
        <h1 class="aside-title">Lista de Canciones</h1> <!--<a href="#" class="all">See All <i class="ion-ios-arrow-right"></i></a>-->
        <div class="aside-body">
          <article class="article-mini">
            <div class="inner">
              <figure>
                <a href="#">
                  <img src="images/ff/m.png" alt="Sample Article">
                </a>
              </figure>
              <div class="padding">
                <h1><a href="#">Texto</a></h1>
          ...
          <div class="tab-pane comments" id="comments">
            <div class="comment-list sm">
              <div class="item">
                <div class="user">
                  <figure>
                    <img src="images/ff/19.jpeg" alt="User Picture">
                  </figure>
                  <div class="details">
              ...
              <div class="item">
                <div class="user">
                  <figure>
                    <img src="images/ff/20.jpeg" alt="User Picture">
                  </figure>
                  <div class="details">
                    <h5 class="name">Mark Otto</h5>
                    <div class="time">24 Hours</div>
              ...
              <div class="item">
                <div class="user">
                  <figure>
                    <img src="images/ff/21.jpeg" alt="User Picture">
                  </figure>
                  <div class="details">
                    <h5 class="name">Mark Otto</h5>
                    <div class="time">24 Hours</div>
